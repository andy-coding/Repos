    ...
    public partial class CookbookDataSet : global::System.Data.DataSet {
        ...
        public partial class IngredientDataTable : global::System.Data.TypedTableBase<IngredientRow> {
            ...
            private void InitClass() {
                ...
                this.columnIngredient.MaxLength = 20;
            }
...
namespace Cookbook.CookbookDataSetTableAdapters {
    ...
    public partial class RecipeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Recipe] WHERE (([RecipeId] = @Original_RecipeId) AND ([Name] =" +
                " @Original_Name) AND ([PrepTime] = @Original_PrepTime))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Recipe] ([Name], [PrepTime], [Instructions]) VALUES (@Name, @P" +
                "repTime, @Instructions);\r\nSELECT RecipeId, Name, PrepTime, Instructions FROM Rec" +
                "ipe WHERE (RecipeId = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Recipe] SET [Name] = @Name, [PrepTime] = @PrepTime, [Instructions] = @Instructions WHERE (([RecipeId] = @Original_RecipeId) AND ([Name] = @Original_Name) AND ([PrepTime] = @Original_PrepTime));
SELECT RecipeId, Name, PrepTime, Instructions FROM Recipe WHERE (RecipeId = @RecipeId)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT RecipeId, Name, PrepTime, Instructions FROM dbo.Recipe";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_RecipeId, string Original_Name, short Original_PrepTime) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, short PrepTime, string Instructions, int Original_RecipeId, string Original_Name, short Original_PrepTime, int RecipeId) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, short PrepTime, string Instructions, int Original_RecipeId, string Original_Name, short Original_PrepTime) {
            return this.Update(Name, PrepTime, Instructions, Original_RecipeId, Original_Name, Original_PrepTime, Original_RecipeId);
        }
    }
